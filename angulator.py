...
class customScript(pypes.pypeScript):
    ...
    def Execute(self):
        ...
        ptCoord = []
        # not taking all points in the VC to avoid using the near-heart region
        npts = int(cc.GetNumberOfPoints() * 0.75)
        for c in xrange(npts):
        ...
        # self.mywriter.OutputFileName = '/home/florian/Downloads/test_surf_open_small_ctrlTESTbranc1.vtp'
